...
complete -c rg -l auto-hybrid-regex --description 'DEPRECATED.  Use --engine instead.'
...
complete -c rg -l engine --description 'Specify which regular expression engine to use.'
...
complete -c rg -l include-zero --description 'When used with --count or --count-matches, print the number of matches for ea…'
...
complete -c rg -l no-ignore-exclude --description 'Don\\(cqt respect ignore files that are manually configured for the repository…'
complete -c rg -l no-ignore-files --description 'When set, any --ignore-file flags, even ones that come after this flag, are i…'
...
complete -c rg -l no-pcre2-unicode --description 'DEPRECATED.  Use --no-unicode instead.'
complete -c rg -l no-require-git --description 'By default, ripgrep will only respect global gitignore rules, .'
complete -c rg -l no-unicode --description 'By default, ripgrep will enable "Unicode mode" in all of its regexes.'
...
complete -c rg -o L/--follow --description 'will force ripgrep to follow symlinks.'
complete -c rg -o uu --description 'is equivalent to.'
complete -c rg -o uuu --description 'is equivalent to.'
