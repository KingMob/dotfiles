...
complete -c brew -l formulae --description 'Without text, list all locally available formulae (no online search is perfor…'
complete -c brew -l casks --description 'Without text, list all locally available casks (including tapped ones, no onl…'
...
complete -c brew -l with-label --description 'Pull requests must have this label (default: ready to merge).'
...
complete -c brew -l workflow --description 'Retrieve artifacts from the specified workflow (default: tests. yml).'
...
complete -c brew -l file --description 'Read the Brewfile from this location.  Use --file=- to pipe to stdin/stdout.'
...
complete -c brew -l brews --description 'list Homebrew dependencies.'
complete -c brew -l taps --description 'list tap dependencies.'
