# projsync
# Autogenerated from man page /usr/local/share/man/man1/projsync.1
...
complete -c projsync -l dry-run --description 'Simulate the behaviour of the tool without downloading resource files.'
