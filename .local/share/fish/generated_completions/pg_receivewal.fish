# pg_receivewal
# Autogenerated from man page /Applications/Postgres.app/Contents/Versions/latest/share/man/man1/pg_receivewal.1
...
complete -c pg_receivewal -s d --description 'Specifies parameters used to connect to the server, as a connection string.'
